...
SCORE_SERIES_MAP: dict[str, list[dict]] = {
    "energy_anomaly": [
        ...
        {
            "col": "raw_predicted_delta",
            "label": "Predicted δ kWh",
            "unit": "kWh",
            "style": "dashed",
        },
    ],
    ...
    "phase_imbalance": [
        ...
        {
            "col": "raw_nema_voltage_imbalance",
            "label": "NEMA V Imbalance",
            "unit": "%",
            "style": "bold",
            "group": "imbalance",
        },
