...
const cases: Array<{ label: string; props: any }> = [
  {
    label: 'On / fresh',
    props: { operationalState: 'On', lastMeasured: new Date().toISOString() },
  },
  { label: 'Off', props: { operationalState: 'Off', lastMeasured: null } },
  {
    label: 'Off · Stale',
    props: { operationalState: 'Off_Stale', lastMeasured: '2020-01-01T00:00:00Z' },
  },
  { label: 'Inactive', props: { operationalState: 'Inactive' } },
  {
    ...
    props: {
      operationalState: 'On',
      lastMeasured: new Date(Date.now() - 12 * 3600_000).toISOString(),
    },
  },
